...
spaceshipScaleUpTL.to("#space-ship",{duration:0.15, rotation: "-=5",ease:"none"})
        ...
        .to("#space-ship", {duration: 1, scale: 20, x: "-=250", y: "+=500", ease: "bounce"})
        .to("#window", {duration: .75, rotation: -360})
        .to("#space-ship", {duration: .75, scale: 1, x: "+=160", y: "-=430", onComplete:startFlames}, "scaleDown")
        ...
        .to("#moon", {duration: .75, scale: .5, x: 580, y: 680}, "scaleDown")
